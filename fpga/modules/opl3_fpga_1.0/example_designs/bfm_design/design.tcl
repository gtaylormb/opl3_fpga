proc create_ipi_design { offsetfile design_name } {
	...
	set opl3_fpga_0 [ create_bd_cell -type ip -vlnv user.org:user:opl3_fpga:1.0 opl3_fpga_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins opl3_fpga_0/S_AXI]
	...
	set offset_file "${bd_path}/opl3_fpga_v1_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef opl3_fpga_v1_0_tb_include_vh_"
	puts $fp "`define opl3_fpga_v1_0_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:opl3_fpga:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/opl3_fpga_v1_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "opl3_fpga_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 opl3_fpga_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top opl3_fpga_v1_0_tb [get_filesets sim_1]
